...
module "waf" {
  ...
  trusted_ips       = concat(split(",", module.global_parameters.trusted_ips), tolist(["${module.shared_vpc.nat_gateway_public_ips[0]}/32", "${module.shared_vpc.nat_gateway_public_ips[1]}/32"]))
