locals {
  ...
  // Region-specific allow rule inputs (only set in prod currently) These are for MyNCSC scanning TDRD-975
  region_allowed_ips_list      = local.environment == "prod" ? ["34.249.80.238/32", "34.251.127.30/32"] : []
