...
module "keycloak_ssm_parameters" {
  ...
  random_parameters = [
    ...
    { name = local.keycloak_tdr_export_client_secret_name, description = "The Keycloak tdr-export client secret", value = random_uuid.client_secret.result, type = "SecureString" },
