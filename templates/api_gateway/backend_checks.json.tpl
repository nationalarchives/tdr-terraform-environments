{
  ...
  "paths": {
    ...
    "/backend-checks-v2/{consignmentId+}": {
      "post": {
        "consumes": [
          "application/json"
        ],
        ...
        "x-amazon-apigateway-integration": {
          ...
          "requestTemplates": {
            "application/json": "{\"input\": \"{\\\"consignmentId\\\": \\\"$input.params('consignmentId')\\\"}\",\"stateMachineArn\": \"${backend_checks_v2_state_machine_arn}\"}"
          },
          "passthroughBehavior": "when_no_templates",
          "httpMethod": "POST",
          "type": "aws"
